...
public class OdemelerEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Baris Bank Ödemeler Ekranı");

        odemelerEkraniPanel.setBackground(new java.awt.Color(0, 153, 153));

        kullaniciAdiSoyadiLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        kullaniciAdiSoyadiLabel.setForeground(new java.awt.Color(0, 102, 102));
        ...
        mesajElektrikLabel.setForeground(new java.awt.Color(0, 51, 102));
        ...
        elektrikBorcu.setForeground(new java.awt.Color(51, 0, 102));
        elektrikBorcu.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        elektrikBorcu.setText("[ELEKT BORC]");

        elektrikOdeButton.setBackground(new java.awt.Color(51, 153, 0));
        ...
        mesajSuLabel.setForeground(new java.awt.Color(0, 51, 102));
        ...
        suBorcu.setForeground(new java.awt.Color(51, 0, 102));
        suBorcu.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        suBorcu.setText("[SU BORC]");

        suOdeButton.setBackground(new java.awt.Color(51, 153, 0));
        ...
        dogalgazOdeButton.setBackground(new java.awt.Color(51, 153, 0));
        ...
        mesajDogalgazLabel.setForeground(new java.awt.Color(0, 51, 102));
        ...
        dogalgazBorcu.setForeground(new java.awt.Color(51, 0, 102));
        ...
        mesajInternetLabel.setForeground(new java.awt.Color(0, 51, 102));
        ...
        internetOdeButton.setBackground(new java.awt.Color(51, 153, 0));
        ...
        internetBorcu.setForeground(new java.awt.Color(51, 0, 102));
            ...
            .addGroup(odemelerEkraniPanelLayout.createSequentialGroup()
                ...
                .addGroup(odemelerEkraniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(odemelerEkraniPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(elektrikOdeButton, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))

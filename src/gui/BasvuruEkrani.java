...
public class BasvuruEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Baris Bank Başvuru Ekranı");

        basvuruEkraniPanel.setBackground(new java.awt.Color(204, 102, 0));
        ...
        tcNoLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        telNoLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        guvenlikSorusuLabel.setForeground(new java.awt.Color(255, 255, 255));
        guvenlikSorusuLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        guvenlikSorusuLabel.setText("Güvenlik Sorusu :");

        guvenlikSorusu.setBackground(new java.awt.Color(204, 204, 204));
        guvenlikSorusu.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        guvenlikSorusu.setForeground(new java.awt.Color(102, 102, 102));
        guvenlikSorusu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Evcil hayvanınızın adı nedir?", "En sevdiğiniz nesne nedir?", "İlkokul öğretmeninizin soyadı nedir?", "Sevgilinizin adı nedir? " }));

        guvenlikCevapLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        guvenlikCevapLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        basvurButton.setBackground(new java.awt.Color(102, 153, 0));
        basvurButton.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
                        ...
                        .addGroup(basvuruEkraniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(basvuruEkraniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(basvuruEkraniPanelLayout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(guvenlikSorusu, 0, 0, Short.MAX_VALUE))

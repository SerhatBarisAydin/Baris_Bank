...
public class SifreYenilemeEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Baris Bank Şifre Yenileme Ekranı");

        sifreYenilemePanel.setBackground(new java.awt.Color(0, 102, 102));

        geriIcon2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/iconlar/arrow.png"))); // NOI18N
        ...
        sifreYenilemeLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        sifreyiYenileButton.setText("Yenile");
                        ...
                        .addGroup(sifreYenilemePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, sifreYenilemePanelLayout.createSequentialGroup()
                                .addGroup(sifreYenilemePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                        .addGap(0, 0, Short.MAX_VALUE)
                                        .addComponent(sifreyiYenileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                        .addGroup(sifreYenilemePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                            ...
                                            .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                                ...
                                                .addGroup(sifreYenilemePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    ...
                                                    .addComponent(telefonNoText, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE))))
                                        .addGroup(sifreYenilemePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                            ...
                                            .addGroup(sifreYenilemePanelLayout.createSequentialGroup()
                                                ...
                                                .addComponent(guvenlikCevapText, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(0, 0, Short.MAX_VALUE)))))
                                .addGap(28, 28, 28)))))
                .addContainerGap())
        );
